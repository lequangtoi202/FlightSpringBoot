...
public class TicketPriceController {
    ...
    public String addTicketPriceForm(Model model, Principal principal) {
        if (principal == null){
    ...
    public String updateTicketPriceForm(@PathVariable("id") Long id, Model model, Principal principal){
        if (principal == null){
            return "redirect:/login";
        }
